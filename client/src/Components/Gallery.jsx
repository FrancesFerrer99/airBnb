            ...
            <div className="absolute inset-0 bg-black text-white min-h-screen">
                <div className="grid gap-4 p-8 bg-black">
                    <div className="">
                        ...
                        <button onClick={() => setShowAllPhotos(false)} className="fixed flex gap-1 px-4 py-2 roudned-2xl  right-12 top-8 bg-white text-black">
            ...
            <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
                ...
                <div className="grid">
                    ...
                    <div className="overflow-hidden">
                        {
                            place.photos?.[2] && (
                                <img onClick={() => setShowAllPhotos(true)} className="aspect-square object-cover" src={'http://localhost:4000/uploads/' + place.photos[2]} />
                            )
                        }
                    </div>
                </div>
            </div>
            <button onClick={() => setShowAllPhotos(true)} className="bg-white rounded-2xl shadow-md shadow-gray-500 absolute bottom-2 right-2 px-4 py-2 ">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
